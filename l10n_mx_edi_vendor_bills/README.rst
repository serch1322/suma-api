...
Note: This module not must be installed if you have l10n_mx_base.
...
- You need the `Vauxoo/Odoo <https://github.com/vauxoo/odoo/>`_ repo, because this have some improves in version 10.0
